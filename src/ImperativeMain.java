import services.BirthRecordImperativeService;
...
public class ImperativeMain {
	...
	public static BirthRecordImperativeService imperativeService = new BirthRecordImperativeService("data.json");
	...
	public static void functionOne() {
		...
		BirthCounts birthCounts = imperativeService.getBirthCountsByDateRange(timeRange.startDate(), timeRange.endDate());
	...
	public static void functionTwo() {
		TimeRange timeRange = getTimeRange();
		Map<String, Integer> birthByNeighbourhood = imperativeService.getBirthsByNeighbourhoodByDateRange(timeRange.startDate(), timeRange.endDate());
	...
	public static void functionThree() {
		...
		long amountOfBirths = imperativeService.countMultipleBirths(timeRange.startDate(), timeRange.endDate(), numberOfChildren);
	...
	public static void functionFour() {
		TimeRange timeRange = getTimeRange();
		Map<String, Double> birthByNationality = imperativeService.getAverageChildrenByNationality(timeRange.startDate(), timeRange.endDate());
	...
	public static void functionFive() {
		...
		Map<String, Long> birthsByDay = imperativeService.getBirthsByDay(day);
